...
/*    if (estimatedBudget > 0) {
        $(document.getElementById("estimated_budget")).css({ color: 'green' });
    }
    else if (estimatedBudget < 0) {
        $(document.getElementById("estimated_budget")).css({ color: 'red' });
    }
    else {
        $(document.getElementById("estimated_budget")).css({ color: 'black'});
    }*/
}
...
function analyzeBudget() {
    ...
    if (budgetToAnalyze <= 0) {
        if (window.confirm("Do not save what is left after spending, but spend what is left after saving! Click OK and we'll guide you.")) {
            window.location.href = 'https://www.cambridge-credit.org/category-kids-and-money.html';
        };
    }
    //if budget is +ve
    else {
